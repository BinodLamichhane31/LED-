...
def personalization_section():
    ...
    def change():
        ...
        def password_change(): 
            ...
            '''
            if user_data['password'] == current_password_entry.get():
                ...
                def confirm_change():
                    ...
                    if new_password_entry.get() == re_password_entry.get():
                        ...
                        football_collection.update_one({'password': user_data['password']}, {'$set': {'password': new_password_entry.get()}})
    ...
    personaliztion_button.append(create_personalization_btns(frame_personaliztion, 'C:/Users/Dell/Desktop/Python Project/Images/change.png', "Change Password", 10, 200, change))
    personaliztion_button.append(create_personalization_btns(frame_personaliztion, 'C:/Users/Dell/Desktop/Python Project/Images/delete.png', "Delete Account", 10, 250, delete))
...
def create_gui():
    ...
    buttons.append(create_button_with_icon(left_frame, "C:/Users/Dell/Desktop/Python Project/Images/home.png", "Home", 20, 150,home_section))
    buttons.append(create_button_with_icon(left_frame, "C:/Users/Dell/Desktop/Python Project/Images/live.png", "Live", 20, 220,live_section))
    buttons.append(create_button_with_icon(left_frame, "C:/Users/Dell/Desktop/Python Project/Images/overview.png", "Overview", 20, 290,overview_section))
    buttons.append(create_button_with_icon(left_frame, "C:/Users/Dell/Desktop/Python Project/Images/matches.png", "Matches", 20, 360,matches_section))
    buttons.append(create_button_with_icon(left_frame, "C:/Users/Dell/Desktop/Python Project/Images/standings.png", "Standings", 20, 430,standing_section))
    buttons.append(create_button_with_icon(left_frame,"C:/Users/Dell/Desktop/Python Project/Images/personalization.png","Personalization",20,500,personalization_section))
    separator = ttk.Separator(left_frame, orient='horizontal', style='Separator.TSeparator')
    separator.place(x=0, y=570, relwidth=1)
    buttons.append(create_button_with_icon(left_frame,"C:/Users/Dell/Desktop/Python Project/Images/feedback.png","Feedback & Support",20,600,feedback_section))
    home_section()
    app.mainloop()
