...
def sign_in():
        def signup_work():
            ...
            if uname=='' or email =='' or phone =='' or password == '' or confirm == '':
                ...
                football_collection.insert_one({'fullName':uname,'email':email,'phone':phone,'password':password})
        ...
        signin_icon = Image.open("C:/Users/Dell/Desktop/Python Project/Images/loginicon.png")
...
def login():
         ...
         if user_data:
            ...
            if stored_psw == psw:
                ...
                with open("phone_number.txt", "w") as file:
                    file.write(phone)
                subprocess.Popen(["python", "C:/Users/Dell/Desktop/Python Project/Scripts/dashboard.py"]) 
            else:
    ...
    global right_frame
    login_icon = Image.open("C:/Users/Dell/Desktop/Python Project/Images/loginicon.png")
    ...
    login_img_label.image = login_image  # Store a reference to the image to prevent it from being garbage collected
    login_img_label.place(x=450,y=165)
    label_login = Label(right_frame, text="Welcome! Please Login into your Account.", bg="sky blue",border=0, font=('Segoe Print', '16', 'bold'))
    ...
    login_button = Button(right_frame,text="LOGIN",font=('Segoe Print', '10', ''),height=1,bg="sky blue",border=1,command=login_work)
    login_button.place(x=460,y=380)

    app.bind('<Return>',lambda e: login_work())

    right_frame_label = Label(right_frame,text="Don't have an account?",font=('Segoe Print','9',''),bg="sky blue",border=0)
    right_frame_label.place(x=380,y=430)
    sign_in_btn = Button(right_frame,text="Sign In",font=('Segoe Print', '9', ''),bg="sky blue",border=0,fg="blue",command=sign_in)
...
football_img = Image.open("C:/Users/Dell/Desktop/Python Project/Images/football.png")
...
kick_png = Image.open("C:/Users/Dell/Desktop/Python Project/Images/pitch.png")
kick_photo = kick_png.resize((400,350))
kick_photo = ImageTk.PhotoImage(kick_photo)
kick_label = Label(left_frame,image=kick_photo,border=0,bg="sky blue")
kick_label.image = kick_photo  
kick_label.place(x=30,y=230)
