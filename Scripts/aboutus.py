...
# Create a canvas
canvas = Canvas(root_frame, background="#FFFACD", width=740, height=600)
...
content_frame = Frame(canvas, background="#FFFACD", width=700, height=600)
content_frame.pack()

# Add the block of information with proper styling and headings
title_label = Label(content_frame, text="Introducing the ultimate A Division Football League App", wraplength=800, font=("Tahoma", 16, "bold"), bg="#FFFACD")
...
feature1_label = Label(content_frame, text="• Real-time match scores, standings, and statistics", font=("Default", 12), bg="#FFFACD")
feature1_label.pack(anchor="w", padx=40)

feature2_label = Label(content_frame, text="• Upcoming fixtures and match schedules", font=("Default", 12), bg="#FFFACD")
feature2_label.pack(anchor="w", padx=40)

feature3_label = Label(content_frame, text="• Personalized notifications for favorite teams", font=("Default", 12), bg="#FFFACD")
